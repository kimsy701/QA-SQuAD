#https://huggingface.co/csarron/bert-base-uncased-squad-v1/blob/main/README.md
...
def train(args, train_dataset, model, tokenizer):
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if args.model_type in ["xlm", "roberta", "distilbert", "camembert", "bart", "longformer","bert"]:
...
def main():
    ...
    parser.add_argument(
        "--output_dir",
        default='data/bert-base-uncased-squad-v1 2>&1 | tee train-energy-bert-base-squad-v1.log',
        type=str,
        required=True,
